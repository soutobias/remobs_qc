...
def adjust_bmo_general(raw_data):
    ...
    bmo_general_data['cspd1'] = pd.to_numeric(raw_data['cspd1'],errors = 'coerce').round(2)
    bmo_general_data['cdir1'] = pd.to_numeric(raw_data['cdir1'], errors='coerce',  downcast='signed').astype(int)
    bmo_general_data['cspd2'] = pd.to_numeric(raw_data['cspd2'], errors = 'coerce').round(2)
    bmo_general_data['cdir2'] = pd.to_numeric(raw_data['cdir2'], errors='coerce',  downcast='signed').astype(int)
    bmo_general_data['cspd3'] = pd.to_numeric(raw_data['cspd3'], errors = 'coerce').round(2)
...
def adjust_bmo_current(raw_data):
    ...
    bmo_general_data['cspd3'] = pd.to_numeric(raw_data['cspd3'], errors = 'coerce').round(2)
    bmo_general_data['cdir3'] = pd.to_numeric(raw_data['cdir3'], errors='coerce',  downcast='signed').astype(int)
    bmo_general_data['cspd4'] = pd.to_numeric(raw_data['cspd4'],errors = 'coerce').round(2)
    bmo_general_data['cdir4'] = pd.to_numeric(raw_data['cdir4'], errors='coerce',  downcast='signed').astype(int)
    bmo_general_data['cspd5'] = pd.to_numeric(raw_data['cspd5'], errors = 'coerce').round(2)
    bmo_general_data['cdir5'] = pd.to_numeric(raw_data['cdir5'], errors='coerce',  downcast='signed').astype(int)
    bmo_general_data['cspd6'] = pd.to_numeric(raw_data['cspd6'], errors = 'coerce').round(2)
    bmo_general_data['cdir6'] = pd.to_numeric(raw_data['cdir6'], errors='coerce',  downcast='signed').astype(int)
    bmo_general_data['cspd7'] = pd.to_numeric(raw_data['cspd7'],errors = 'coerce').round(2)
    bmo_general_data['cdir7'] = pd.to_numeric(raw_data['cdir7'], errors='coerce',  downcast='signed').astype(int)
    bmo_general_data['cspd8'] = pd.to_numeric(raw_data['cspd8'], errors = 'coerce').round(2)
    bmo_general_data['cdir8'] = pd.to_numeric(raw_data['cdir8'], errors='coerce',  downcast='signed').astype(int)
    bmo_general_data['cspd9'] = pd.to_numeric(raw_data['cspd9'], errors = 'coerce').round(2)
    bmo_general_data['cdir9'] = pd.to_numeric(raw_data['cdir9'], errors='coerce',  downcast='signed').astype(int)
    bmo_general_data['cspd10'] = pd.to_numeric(raw_data['cspd10'],errors = 'coerce').round(2)
    bmo_general_data['cdir10'] = pd.to_numeric(raw_data['cdir10'], errors='coerce',  downcast='signed').astype(int)
    bmo_general_data['cspd11'] = pd.to_numeric(raw_data['cspd11'], errors = 'coerce').round(2)
    bmo_general_data['cdir11'] = pd.to_numeric(raw_data['cdir11'], errors='coerce',  downcast='signed').astype(int)
    bmo_general_data['cspd12'] = pd.to_numeric(raw_data['cspd12'], errors = 'coerce').round(2)
    bmo_general_data['cdir12'] = pd.to_numeric(raw_data['cdir12'], errors='coerce',  downcast='signed').astype(int)
    bmo_general_data['cspd13'] = pd.to_numeric(raw_data['cspd13'],errors = 'coerce').round(2)
    bmo_general_data['cdir13'] = pd.to_numeric(raw_data['cdir13'], errors='coerce',  downcast='signed').astype(int)
    bmo_general_data['cspd14'] = pd.to_numeric(raw_data['cspd14'], errors = 'coerce').round(2)
    bmo_general_data['cdir14'] = pd.to_numeric(raw_data['cdir14'], errors='coerce',  downcast='signed').astype(int)
    bmo_general_data['cspd15'] = pd.to_numeric(raw_data['cspd15'], errors = 'coerce').round(2)
    bmo_general_data['cdir15'] = pd.to_numeric(raw_data['cdir15'], errors='coerce',  downcast='signed').astype(int)
    bmo_general_data['cspd16'] = pd.to_numeric(raw_data['cspd16'],errors = 'coerce').round(2)
    bmo_general_data['cdir16'] = pd.to_numeric(raw_data['cdir16'], errors='coerce',  downcast='signed').astype(int)
    bmo_general_data['cspd17'] = pd.to_numeric(raw_data['cspd17'], errors = 'coerce').round(2)
    bmo_general_data['cdir17'] = pd.to_numeric(raw_data['cdir17'], errors='coerce',  downcast='signed').astype(int)
    bmo_general_data['cspd18'] = pd.to_numeric(raw_data['cspd18'], errors = 'coerce').round(2)
    bmo_general_data['cdir18'] = pd.to_numeric(raw_data['cdir18'], errors='coerce',  downcast='signed').astype(int)
...
def adjust_bmo_qc(bmo_qc_data):
    ...
    bmo_qc_adjusted['cspd1'] = pd.to_numeric(bmo_qc_data['cspd1'],errors = 'coerce').round(2)
    bmo_qc_adjusted['cdir1'] = pd.to_numeric(bmo_qc_data['cdir1'], errors='coerce',  downcast='signed').astype(int)
    bmo_qc_adjusted['cspd2'] = pd.to_numeric(bmo_qc_data['cspd2'], errors = 'coerce').round(2)
    bmo_qc_adjusted['cdir2'] = pd.to_numeric(bmo_qc_data['cdir2'], errors='coerce',  downcast='signed').astype(int)
    bmo_qc_adjusted['cspd3'] = pd.to_numeric(bmo_qc_data['cspd3'], errors = 'coerce').round(2)
